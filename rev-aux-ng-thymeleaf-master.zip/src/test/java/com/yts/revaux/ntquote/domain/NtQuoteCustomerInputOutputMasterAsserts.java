...
public class NtQuoteCustomerInputOutputMasterAsserts {
     ...
     */
    public static void assertNtQuoteCustomerInputOutputMasterAllPropertiesEquals(
        NtQuoteCustomerInputOutputMaster expected,
        NtQuoteCustomerInputOutputMaster actual
    ) {
        assertNtQuoteCustomerInputOutputMasterAutoGeneratedPropertiesEquals(expected, actual);
        assertNtQuoteCustomerInputOutputMasterAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertNtQuoteCustomerInputOutputMasterAllUpdatablePropertiesEquals(
        NtQuoteCustomerInputOutputMaster expected,
        NtQuoteCustomerInputOutputMaster actual
    ) {
        assertNtQuoteCustomerInputOutputMasterUpdatableFieldsEquals(expected, actual);
        assertNtQuoteCustomerInputOutputMasterUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertNtQuoteCustomerInputOutputMasterAutoGeneratedPropertiesEquals(
        NtQuoteCustomerInputOutputMaster expected,
        NtQuoteCustomerInputOutputMaster actual
    ) {
        assertThat(expected)
            .as("Verify NtQuoteCustomerInputOutputMaster auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertNtQuoteCustomerInputOutputMasterUpdatableFieldsEquals(
        NtQuoteCustomerInputOutputMaster expected,
        NtQuoteCustomerInputOutputMaster actual
    ) {
        assertThat(expected)
            .as("Verify NtQuoteCustomerInputOutputMaster relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertNtQuoteCustomerInputOutputMasterUpdatableRelationshipsEquals(
        NtQuoteCustomerInputOutputMaster expected,
        NtQuoteCustomerInputOutputMaster actual
    ) {
        // empty method
