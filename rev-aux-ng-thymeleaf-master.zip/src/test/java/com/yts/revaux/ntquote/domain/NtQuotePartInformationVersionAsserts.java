...
public class NtQuotePartInformationVersionAsserts {
     ...
     */
    public static void assertNtQuotePartInformationVersionAllPropertiesEquals(
        NtQuotePartInformationVersion expected,
        NtQuotePartInformationVersion actual
    ) {
        assertNtQuotePartInformationVersionAutoGeneratedPropertiesEquals(expected, actual);
        assertNtQuotePartInformationVersionAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertNtQuotePartInformationVersionAllUpdatablePropertiesEquals(
        NtQuotePartInformationVersion expected,
        NtQuotePartInformationVersion actual
    ) {
        assertNtQuotePartInformationVersionUpdatableFieldsEquals(expected, actual);
        assertNtQuotePartInformationVersionUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertNtQuotePartInformationVersionAutoGeneratedPropertiesEquals(
        NtQuotePartInformationVersion expected,
        NtQuotePartInformationVersion actual
    ) {
        assertThat(expected)
            .as("Verify NtQuotePartInformationVersion auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertNtQuotePartInformationVersionUpdatableFieldsEquals(
        NtQuotePartInformationVersion expected,
        NtQuotePartInformationVersion actual
    ) {
        assertThat(expected)
            .as("Verify NtQuotePartInformationVersion relevant properties")
            ...
            .satisfies(e -> assertThat(e.getQuoteType()).as("check quoteType").isEqualTo(actual.getQuoteType()))
     ...
     * @param actual the actual entity
     */
    public static void assertNtQuotePartInformationVersionUpdatableRelationshipsEquals(
        NtQuotePartInformationVersion expected,
        NtQuotePartInformationVersion actual
    ) {
        assertThat(expected)
            .as("Verify NtQuotePartInformationVersion relationships")
