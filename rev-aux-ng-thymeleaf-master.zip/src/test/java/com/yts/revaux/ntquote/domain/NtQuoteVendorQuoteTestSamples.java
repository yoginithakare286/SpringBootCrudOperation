...
public class NtQuoteVendorQuoteTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static NtQuoteVendorQuote getNtQuoteVendorQuoteSample1() {
    ...
    public static NtQuoteVendorQuote getNtQuoteVendorQuoteSample2() {
        return new NtQuoteVendorQuote()
            .id(2L)
            .srNo(2)
    ...
    public static NtQuoteVendorQuote getNtQuoteVendorQuoteRandomSampleGenerator() {
        return new NtQuoteVendorQuote()
