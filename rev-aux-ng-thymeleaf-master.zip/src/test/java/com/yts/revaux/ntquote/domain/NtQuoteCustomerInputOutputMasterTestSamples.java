...
public class NtQuoteCustomerInputOutputMasterTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static NtQuoteCustomerInputOutputMaster getNtQuoteCustomerInputOutputMasterSample1() {
    ...
    public static NtQuoteCustomerInputOutputMaster getNtQuoteCustomerInputOutputMasterSample2() {
        return new NtQuoteCustomerInputOutputMaster()
            .id(2L)
            .srNo(2)
    ...
    public static NtQuoteCustomerInputOutputMaster getNtQuoteCustomerInputOutputMasterRandomSampleGenerator() {
        return new NtQuoteCustomerInputOutputMaster()
