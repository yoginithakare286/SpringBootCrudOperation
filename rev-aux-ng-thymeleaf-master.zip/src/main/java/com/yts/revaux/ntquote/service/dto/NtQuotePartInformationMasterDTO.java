...
/**
 * A DTO for the {@link com.yts.revaux.ntquote.domain.NtQuotePartInformationMaster} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NtQuotePartInformationMasterDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NtQuotePartInformationMasterDTO)) {
            return false;
        }

        NtQuotePartInformationMasterDTO ntQuotePartInformationMasterDTO = (NtQuotePartInformationMasterDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, ntQuotePartInformationMasterDTO.id);
    }
    ...
    public String toString() {
        return "NtQuotePartInformationMasterDTO{" +
            "id=" + getId() +
            ", srNo=" + getSrNo() +
            ", uid='" + getUid() + "'" +
