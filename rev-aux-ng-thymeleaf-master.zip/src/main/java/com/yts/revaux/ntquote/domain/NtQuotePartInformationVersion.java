...
/**
 * A NtQuotePartInformationVersion.
 */
@Entity
@Table(name = "nt_quote_part_information_version")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "ntquotepartinformationversion")
...
public class NtQuotePartInformationVersion implements Serializable {
    ...
    public NtQuotePartInformationVersion id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public NtQuotePartInformationVersion srNo(Integer srNo) {
        this.setSrNo(srNo);
        return this;
    }
    ...
    public NtQuotePartInformationVersion uid(UUID uid) {
        this.setUid(uid);
        return this;
    }
    ...
    public NtQuotePartInformationVersion materialDescription(String materialDescription) {
    ...
    public NtQuotePartInformationVersion partNumber(String partNumber) {
    ...
    public NtQuotePartInformationVersion cadFile(String cadFile) {
    ...
    public NtQuotePartInformationVersion eau(Integer eau) {
        this.setEau(eau);
        return this;
    }
    ...
    public NtQuotePartInformationVersion partWeight(Integer partWeight) {
    ...
    public NtQuotePartInformationVersion materialType(String materialType) {
    ...
    public NtQuotePartInformationVersion materialCost(BigDecimal materialCost) {
    ...
    public NtQuotePartInformationVersion extendedMaterialCostPer(BigDecimal extendedMaterialCostPer) {
    ...
    public NtQuotePartInformationVersion externalMachineCostPer(BigDecimal externalMachineCostPer) {
    ...
    public NtQuotePartInformationVersion purchaseComponentCost(BigDecimal purchaseComponentCost) {
    ...
    public NtQuotePartInformationVersion secondaryExternalOperationCost(BigDecimal secondaryExternalOperationCost) {
    ...
    public NtQuotePartInformationVersion overhead(BigDecimal overhead) {
    ...
    public NtQuotePartInformationVersion packLogisticCostPer(BigDecimal packLogisticCostPer) {
    ...
    public NtQuotePartInformationVersion machineSizeTons(String machineSizeTons) {
    ...
    public NtQuotePartInformationVersion numberOfCavities(Integer numberOfCavities) {
    ...
    public NtQuotePartInformationVersion cycleTime(Integer cycleTime) {
    ...
    public NtQuotePartInformationVersion perUnit(BigDecimal perUnit) {
    ...
    public NtQuotePartInformationVersion totalPricePerChina(BigDecimal totalPricePerChina) {
    ...
    public NtQuotePartInformationVersion totalPriceBudget(BigDecimal totalPriceBudget) {
    ...
    public NtQuotePartInformationVersion grainBudget(BigDecimal grainBudget) {
    ...
    public NtQuotePartInformationVersion dogatingFixtureBudget(BigDecimal dogatingFixtureBudget) {
    ...
    public NtQuotePartInformationVersion gaugeBudget(BigDecimal gaugeBudget) {
    ...
    public NtQuotePartInformationVersion eoat(BigDecimal eoat) {
        this.setEoat(eoat);
        return this;
    }
    ...
    public NtQuotePartInformationVersion chinaTariffBudget(BigDecimal chinaTariffBudget) {
    ...
    public NtQuotePartInformationVersion totalToolingBudget(BigDecimal totalToolingBudget) {
    ...
    public NtQuotePartInformationVersion leadTime(String leadTime) {
    ...
    public NtQuotePartInformationVersion toolingNotes(String toolingNotes) {
    ...
    public NtQuotePartInformationVersion partDescription(String partDescription) {
    ...
    public NtQuotePartInformationVersion jobId(String jobId) {
        this.setJobId(jobId);
        return this;
    }
    ...
    public NtQuotePartInformationVersion moldId(String moldId) {
    ...
    public NtQuotePartInformationVersion quoteType(String quoteType) {
    ...
    public NtQuotePartInformationVersion comments(String comments) {
    ...
    public NtQuotePartInformationVersion createdBy(String createdBy) {
    ...
    public NtQuotePartInformationVersion createdDate(Instant createdDate) {
    ...
    public NtQuotePartInformationVersion updatedBy(String updatedBy) {
    ...
    public NtQuotePartInformationVersion updatedDate(Instant updatedDate) {
    ...
    public NtQuotePartInformationVersion ntQuote(NtQuote ntQuote) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NtQuotePartInformationVersion)) {
            return false;
        }
        return getId() != null && getId().equals(((NtQuotePartInformationVersion) o).getId());
    }
    ...
    public String toString() {
        return "NtQuotePartInformationVersion{" +
            "id=" + getId() +
            ", srNo=" + getSrNo() +
            ", uid='" + getUid() + "'" +
