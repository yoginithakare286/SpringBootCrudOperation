...
/**
 * Criteria class for the {@link com.yts.revaux.ntquote.domain.NtQuoteVendorPo} entity. This class is used
 * in {@link com.yts.revaux.ntquote.web.rest.NtQuoteVendorPoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /nt-quote-vendor-pos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NtQuoteVendorPoCriteria implements Serializable, Criteria {
    ...
    public NtQuoteVendorPoCriteria() {}

    public NtQuoteVendorPoCriteria(NtQuoteVendorPoCriteria other) {
    ...
    @Override
    public NtQuoteVendorPoCriteria copy() {
        return new NtQuoteVendorPoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NtQuoteVendorPoCriteria that = (NtQuoteVendorPoCriteria) o;
        return (
    ...
    public String toString() {
        return "NtQuoteVendorPoCriteria{" +
