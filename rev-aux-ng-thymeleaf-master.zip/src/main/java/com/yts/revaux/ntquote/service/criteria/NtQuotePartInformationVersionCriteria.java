...
/**
 * Criteria class for the {@link com.yts.revaux.ntquote.domain.NtQuotePartInformationVersion} entity. This class is used
 * in {@link com.yts.revaux.ntquote.web.rest.NtQuotePartInformationVersionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /nt-quote-part-information-versions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NtQuotePartInformationVersionCriteria implements Serializable, Criteria {
    ...
    private StringFilter quoteType;
    ...
    public NtQuotePartInformationVersionCriteria() {}

    public NtQuotePartInformationVersionCriteria(NtQuotePartInformationVersionCriteria other) {
        ...
        this.quoteType = other.optionalQuoteType().map(StringFilter::copy).orElse(null);
    ...
    @Override
    public NtQuotePartInformationVersionCriteria copy() {
        return new NtQuotePartInformationVersionCriteria(this);
    }
    ...
    public StringFilter getQuoteType() {
        return quoteType;
    }

    public Optional<StringFilter> optionalQuoteType() {
        return Optional.ofNullable(quoteType);
    }

    public StringFilter quoteType() {
        if (quoteType == null) {
            setQuoteType(new StringFilter());
        }
        return quoteType;
    }

    public void setQuoteType(StringFilter quoteType) {
    ...
    public boolean equals(Object o) {
        ...
        final NtQuotePartInformationVersionCriteria that = (NtQuotePartInformationVersionCriteria) o;
        return (
    ...
    public String toString() {
        return "NtQuotePartInformationVersionCriteria{" +
            ...
            optionalQuoteType().map(f -> "quoteType=" + f + ", ").orElse("") +
