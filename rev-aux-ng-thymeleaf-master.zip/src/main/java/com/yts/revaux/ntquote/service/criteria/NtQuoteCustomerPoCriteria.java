...
/**
 * Criteria class for the {@link com.yts.revaux.ntquote.domain.NtQuoteCustomerPo} entity. This class is used
 * in {@link com.yts.revaux.ntquote.web.rest.NtQuoteCustomerPoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /nt-quote-customer-pos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NtQuoteCustomerPoCriteria implements Serializable, Criteria {
    ...
    public NtQuoteCustomerPoCriteria() {}

    public NtQuoteCustomerPoCriteria(NtQuoteCustomerPoCriteria other) {
    ...
    @Override
    public NtQuoteCustomerPoCriteria copy() {
        return new NtQuoteCustomerPoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NtQuoteCustomerPoCriteria that = (NtQuoteCustomerPoCriteria) o;
        return (
    ...
    public String toString() {
        return "NtQuoteCustomerPoCriteria{" +
