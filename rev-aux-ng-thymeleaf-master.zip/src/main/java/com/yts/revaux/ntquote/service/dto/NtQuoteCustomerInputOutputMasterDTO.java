...
/**
 * A DTO for the {@link com.yts.revaux.ntquote.domain.NtQuoteCustomerInputOutputMaster} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NtQuoteCustomerInputOutputMasterDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NtQuoteCustomerInputOutputMasterDTO)) {
            return false;
        }

        NtQuoteCustomerInputOutputMasterDTO ntQuoteCustomerInputOutputMasterDTO = (NtQuoteCustomerInputOutputMasterDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, ntQuoteCustomerInputOutputMasterDTO.id);
    }
    ...
    public String toString() {
        return "NtQuoteCustomerInputOutputMasterDTO{" +
            "id=" + getId() +
            ", srNo=" + getSrNo() +
            ", uid='" + getUid() + "'" +
